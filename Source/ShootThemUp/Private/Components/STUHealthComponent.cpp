...
{
    UE_LOG(LogHealthComponent, Display, TEXT("OnTake Any Damage: %f"), Damage);
}
    ...
    AActor* DamageCauser)
{
    ...
    UE_LOG(LogHealthComponent, Display, TEXT("OnTake Point Damage: %f, final damage %f, bone: %s"), Damage, FinalDamage, *BoneName.ToString());
...
{
    UE_LOG(LogHealthComponent, Display, TEXT("OnTake Radial Damage: %f"), Damage);
